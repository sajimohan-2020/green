...
export async function load({ fetch, params }) {
  ...
  try {
    ...
    try {
      serviceDetails = await directus.request(
      ...
      // Service details might not exist for all services
      console.log("Service details not found for:", pageId);
      serviceDetails = null;
    }
